...
# Fortigate Rules & Decoders
- ### Rules
  - Goto /var/ossec/ruleset/rules/ and create a file 0391-fortigate_rules.xml.
  ```bash
  cd /var/ossec/ruleset/rules
  nano 0391-fortigate_rules.xml
  ```
  - Add the [Fortigate Rules](https://github.com/effaaykhan/Wazuh/blob/main/0391-fortigate_rules.xml) in the newly created file.
- ### Decoders
  - Goto /var/ossec/ruleset/decoders/ and create a file 0100-fortigate_decoders.xml.
  ```bash
  cd /var/ossec/ruleset/decoders
  nano 0100-fortigate_decoders.xml
  ```
  - Add the [Fortigate Decoders](https://github.com/effaaykhan/Wazuh/blob/main/0100-fortigate_decoders.xml) in the newly created file.
